...
public class UserBillItemForm extends JFrame {
    ...
    private JButton clearButton; // Replaced listButton with clearButton

    private JTable billItemTable;
    private DefaultTableModel tableModel;
    private BillItemDAO billItemDAO;

    public UserBillItemForm() {
        setTitle("User Bill Item Form");
        setSize(1200, 600);
        ...
        buttonPanel.add(clearButton); // Added clearButton instead of listButton
    ...
    private void createUIComponents() {
        ...
        clearButton = new JButton("Clear Fields"); // New clear button
        ...
        clearButton.addActionListener(e -> clearFields()); // Clear fields when clearButton is pressed
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new UserBillItemForm().setVisible(true));
    }
}
